...
import { StyleSheet, Alert, View, Button, TextInput, Image } from 'react-native';
      ...
      <View style={styles.buttonsContainer}>
        <ThemedView style={styles.card}>
          ...
          <View style={styles.textContainer}>
            <ThemedText type="subtitle" style={styles.title}>Preference Quiz</ThemedText>
            <ThemedText style={styles.subtitle}>Help us learn more about you</ThemedText>
          </View>
        </ThemedView>
      </View>
      <View>
