...
const ThemeContainer = () => {
  ...
  const renderCard = useCallback(({item, index} : {item: string, index: number}) => {
    return(
  ...
  return (
    <View style={styles.container}>
      ...
      <LinearGradient style={styles.topFade} colors={["#D9F0F8FF", "#D9F0F811"]}></LinearGradient>
      <LinearGradient style={styles.bottomFade} colors={["#D9F0F811", "#D9F0F8FF"]}></LinearGradient>
    </View>
  )
}
